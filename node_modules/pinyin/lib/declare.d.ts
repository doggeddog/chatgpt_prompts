...
export declare type IPinyinStyle = ENUM_PINYIN_STYLE | "normal" | "tone" | "tone2" | "to3ne" | "initials" | "first_letter" | // 推荐使用小写，和输出的拼音一致
...
export declare type IPinyinSegment = "nodejieba" | "segmentit" | "@node-rs/jieba";
