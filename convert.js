...
function convert() {
  ...
  for (const item of data) {
    ...
    var text = item.prompt.slice(0, 50)
    var match = findMatch(text)

    if (match) {
      newItem["title"] = match.title;
  ...
  fs.writeFileSync(`prompts.json`, JSON.stringify(mainList, null, 2))
  //var englishPrompts = build("description");
